...
class Company extends Model
{
    ...
    {
        return $this->belongsToMany(User::class)->wherePivotIn('role', ['admin', 'employee']);
    }

    public function scopeInvitees()
    {
        return $this->belongsToMany(User::class)->wherePivot('role', 'invitee');
    }
}
