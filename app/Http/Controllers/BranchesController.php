...
class BranchesController extends Controller
{
    ...
    {
        $this->authorize('viewAny', [Branch::class, $company]);

        return $company->branches->toJson(JSON_PRETTY_PRINT);
    }
    ...
    {
        $this->authorize('view', [$branch, $company]);

        return $branch->toJson(JSON_PRETTY_PRINT);
    }
